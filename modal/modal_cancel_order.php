<!-- cancel order-->
<div class="modal fade de" id="cancel_order<?php echo $purchase_ID ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-body">
            
                <form action="./connect/con_cancel_notpaid.php" method="POST" enctype="multipart/form-data">
                   <img class="imgmodal" src="https://static.vecteezy.com/system/resources/previews/003/058/473/non_2x/remove-and-cancel-order-vector.jpg" width="50%">
                    <h3 class="delete_sure">คุณต้องการยกเลิกออเดอร์นี้</h3>
                    <hr>
                    <div class="modal-btn">
...
<div class="modal fade bd-example-modal-xl modal-detail" id="show<?php echo $purchase_ID ?>"  tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
