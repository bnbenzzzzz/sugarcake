<?php
	...
	if($numuser>0){
		echo "<script>alert('มีชื่อผู้ใช้นี้แล้วโปรดเปลี่ยนชื่อผู้ใช้')</script>";  
		echo "<script>window.location='../backed_customer.php'</script>";
	}else {
    ...
    values ('$user_fname','$user_lname','$user_username','$user_pass','$user_email','$user_birth','$user_tel','$user_gender','$pic3',1,'$date')";
	...
	echo "<script>window.alert('Create Success Please LOGIN')</script>";
	header('location:../backed_customer.php');
	}
?>