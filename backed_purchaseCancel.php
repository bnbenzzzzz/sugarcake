...
<head>
    <link rel="stylesheet" href="css/backed_purchaseCancel.css">
            ...
            <div class="tp">
                ...
                <div class="bar">
                    ...
                    <?php $qrynew_ord = "SELECT * FROM purchaseorder  WHERE (purchaseorder.purchase_status='สั่งซื้อแล้วรอการอนุมัติ' OR purchaseorder.purchase_status='ออเดอร์ผิดพลาด') ";
                        ...
                        <a class="active" href="backed_purchaseCancel.php"><span> ยกเลิก</span></a>
                    </div>
                </div>
                ...
                <div class="row filte">
                    <form name="FilterForm" id="FilterForm" action="backed_purchaseCancel.php" method="GET">
                        
                        

                        <div>
                            <label class="se-fi">วันที่เริ่มสั่ง</label>
                        ...
                        <div>
                            ...
                            <input type="date" placeholder="dd-mm-yyyy" class="form-control inputend" placeholder="End" name="date2" data-date-format="DD MMMM YYYY" />
                        </div>
                ...
                <table id="table" class="table1">
                    ...
                    if ((!empty($_GET['date1'])) || (!empty($_GET['date2']))) {
                        ...
                        ?>
                            ...
                            <a href="#" class="fil">วันที่ยกเลิก : <?php echo date("d/m/Y", strtotime($_GET['date1'])) . ' - ' . date("d/m/Y", strtotime($_GET['date2'])) ?> </a>

                            <a class="reset" href="backed_purchaseCancel.php">รีเซ็ตตัวกรอง</a>

                            <?php


                            $sql = "SELECT * FROM purchaseorder JOIN user ON purchaseorder.user_username=user.user_username 
                            WHERE purchaseorder.purchase_status='ยกเลิกออเดอร์' OR purchaseorder.purchase_status='ออเดอร์ผิดพลาด' $ifIssetDate
                            ...
                            ?>
                                    ...
                                    <tr class="tr-shadow">
                                        ...
                                        <td class="price"><b style="color: red;"> <?php echo number_format($row['purchase_price']) ?> ฿</b></td>

                                        <td><a href="#showCancel<?php echo $row3["purchase_id"]; ?>" data-toggle="modal" class="btn_detail"><i class="bi bi-file-text-fill"></a></td>
                                        <td><?php include('modal/modal_show_purchaseCancel.php'); ?></td>
                                    </tr>
                                    <tr class="space"></tr>
                    ...
                    ?>
                        <tbody>
                            <?php
                            $sql = "SELECT * FROM purchaseorder JOIN user ON purchaseorder.user_username=user.user_username WHERE (purchaseorder.purchase_status='ยกเลิกออเดอร์' OR purchaseorder.purchase_status='ออเดอร์ผิดพลาด')  ";
                                    ...
                                    <tr class="tr-shadow">
                                                ...
                                                <td><?php
                                                    if ($row['payment_status'] == '1') {
                                                        echo '<span class="half">' . "จ่ายเต็ม" . "</span>";
                                                    } elseif ($row['payment_status'] == '2') {
                                                        echo '<span class="full">' . "มัดจำ" . "</span>";
                                                    } else {
                                                        echo "อื่นๆ";
                                                    }
                                                    ?></td>
                                                <td><a href="#showCancel<?php echo $row["purchase_id"]; ?>" data-toggle="modal" class="btn_detail"><i class="bi bi-file-text-fill"></a></td>
                                                <td><?php include('modal/modal_show_purchaseCancel.php'); ?></td>
